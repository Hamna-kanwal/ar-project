...
export const SLIDES = [
  ...
  { title: "Megaflo Unvented Cylinder Installation", desc: "High-pressure hot water for busy homes. G3-qualified engineers supply and install Megaflo unvented cylinders professional, certified and cost-effective.", img: "/mega.jpg", buttonText: "Megaflo Installation", buttonLink: "/megaflo-installation" },
  { title: "Hive Smart Thermostat Installation", desc: "Control your heating from your phone and cut energy bills. Gas Safe engineers install and configure Hive standalone or with your new boiler.", img: "/nest4.jpg", buttonText: "Hive Thermostat Installation", buttonLink: "/hive-installation" },
  { title: "Gas Appliance & General Installation", desc: " Gas cookers, hobs, washing machines and dishwashers installed safely and compliantly by qualified engineers alongside our boiler, heating and plumbing services.", img: "/plumbing2.jpg", buttonText: "Boiler Installation", buttonLink: "/boiler-installation" },
];
