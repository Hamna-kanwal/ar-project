  ...
  <div className="flex items-center gap-4">
    ...
    <a href="#" className="hover:text-gray-200"><FaInstagram size={18} /></a>
      ...
      <header className="absolute top-6  left-0 w-full z-50 bg-transparent">
        ...
        <nav className="py-6 px-10 md:px-4 flex items-center justify-between mt-2 md:mt-0">
...
/>
          ...
          <button 
            ...
            className="p-2 bg-[#027cc1] mt-12 md:mt-3 hover:bg-[#027cc1] backdrop-blur-sm rounded-[8px] transition-all order border-white/20"
          >
