    ...
    <div className="w-full h-[550px] rounded-3xl overflow-hidden border-8 border-white shadow-2xl relative z-0">
      ...
      >
        ...
        <Marker position={position} icon={customRedIcon}>
          <Popup>
            <div className="p-1">
              <h4 className="font-bold text-[#027cc1] m-0">Our Office</h4>
              <p className="text-xs text-gray-600 m-0">24 The Roundway, Watford WD18 6LB</p>
            </div>
          </Popup>
        </Marker>
      </MapContainer>
