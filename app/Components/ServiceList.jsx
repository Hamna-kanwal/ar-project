...
const SERVICES = [
  { name: "Boiler Installation", desc: " A-rated combi, system and conventional boilers installed with manufacturer warranties up to 10 years.", icon: <Wrench />, link: "/Services/boiler" },
  { name: "Heating Installation", desc: "Complete central heating design and installation, tailored to your home and budget.", icon: <Flame />, link: "/Services/heating-installation" },
  { name: "Boiler Repair", desc: "Same day diagnosis and repair for all major boiler brands, error codes and breakdowns.", icon: <AlertTriangle />, link: "/Services/boiler-breakdown" },
  { name: "Central Heating", desc: "Radiators, pipework and controls designed, fitted and balanced for even, efficient warmth.", icon: <ThermometerSun />, link: "/Services/central-heating" },
  { name: "Underfloor Heating", desc: "Wet and electric underfloor heating installed for modern, energy-efficient comfort.", icon: <Home />, link: "/Services/underfloor-heating" },
  { name: "General Installation", desc: "Safe, certified installation of gas cookers, hobs and heating system components.", icon: <Briefcase />, link: "/Services/general-installation" },
  { name: "Thermostat Install", desc: "Smart and programmable thermostats fitted for better control and lower energy bills.", icon: <Thermometer />, link: "/Services/thermostat-installation" },
  { name: "Landlord Certificate", desc: "CP12 gas safety inspections for rental properties, with same-day certificates issued.", icon: <ShieldCheck />, link: "/Services/landlord" },
  { name: "Emergency Services", desc: "24/7 emergency plumbers and heating engineers at your door in 60–90 minutes.", icon: <Zap />, link: "/Services/emergency-services" },
