...
const faqs = [
  { q: "My boiler has stopped. What now?  ", a: "Call us with the make and any fault code on the screen. We come out, find the fault, and fix the problem. " },
  { q: "Do you carry spare parts? ", a: "Yes. Our vans hold common parts, so we sort many faults on the first visit. " },
  { q: "Should I repair or replace?  ", a: " We give you a straight answer. If repairs cost more than the boiler is worth, a new one is often the wiser buy.  " },
  ...
  return (
    <>
      ...
      <section className="relative w-full h-[500px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/heatinginstallation1.jpg')" }} />
        <div className="absolute inset-0 bg-white/80" /> 
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight text-[#027cc1]">
            Boiler Breakdown<span className="text-orange-500"> & Repair </span>
          </h1>
          <p className="text-lg text-gray-800 max-w-2xl mx-auto mt-6 font-medium">
A dead boiler in winter is no joke. We come fast, find the fault, and get your heat and hot water back. 

Our engineers carry common parts, so many repairs are done in one visit. 
          </p>
