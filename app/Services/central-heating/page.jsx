...
const faqs = [
  { q: "How long does a full system fit take?  ", a: "Most take two to four days, based on the size of your home.  " },
  { q: "Can you fit heating in an older home? ", a: "Yes. We work with older homes and plan the job around what is already in place. " },
  { q: "How many radiators do I need?  ", a: "We work this out from your room sizes, so each space stays warm. " },
];
    ...
    <>
      ...
      <section className="relative w-full h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight text-[#027cc1] flex flex-wrap justify-center gap-x-3">
  <span>Central Heating</span>
  <span className="text-orange-500 whitespace-nowrap">System Installation</span>
</h1>
       <p className="text-lg text-gray-800 max-w-2xl mx-auto mt-6 font-medium">
A full central heating system warms your whole home from one boiler. We plan, fit, and test the lot, so every room feels right. 

We size the system to your home, so heat spreads even and bills stay low.
          </p>
