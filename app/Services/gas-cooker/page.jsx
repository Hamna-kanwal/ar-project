...
const faqs = [
  { q: "Can I fit a gas cooker myself? ", a: "No. By law, a gas cooker must go in by a Gas Safe engineer. " },
  { q: "How long does the fit take? ", a: "Most fits take under an hour.   " },
  { q: "Do you check for leaks? ", a: "Yes. We test every joint before we leave.  " },
];
...
Gas Cooker <span className="text-orange-500"> Installation</span>
          </h1>
          <p className="text-lg text-gray-800 max-w-2xl mx-auto mt-6 font-medium">
           A gas cooker must go in by a Gas Safe engineer, and we are one. We fit your cooker and make sure the job is safe. 

We hook up the cooker, check for leaks, and test the flame before we go. 
          </p>
