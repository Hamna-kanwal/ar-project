...
const faqs = [
  { q: "What kind of jobs do you take on?  ", a: "A wide range of heating and plumbing work. If you are not sure, just ask. " },
  { q: "Do you charge for a quote? ", a: "No. We give free, clear quotes before any work starts.  " },
  { q: "Can you do small jobs? ", a: "Yes. No job is too small for us. " },
];
...
General<span className="text-orange-500"> Installation</span>
          </h1>
          <p className="text-lg text-gray-800 max-w-2xl mx-auto mt-6 font-medium">
           Got a fitting or set up job at home? We handle a wide range of heating and plumbing work, big and small. 

Tell us what you need and we give you a straight price and a clean fit. 
          </p>
