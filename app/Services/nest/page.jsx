...
const faqs = [
  { q: "Does Nest work with my boiler?  ", a: "Nest works with most systems. We check yours first to be sure.  " },
  { q: "Do I need wifi for Nest?  ", a: "Yes. Nest uses your home wifi and the app.  " },
    { q: "Can Nest cut my bills?  ", a: "Used well, yes. Nest trims waste by heating only when you need. " },
];
...
Link the app to your phone and run your heat from any place. 
          </p>
