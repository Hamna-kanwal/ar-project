...
const faqs = [
  { q: "Does underfloor heating work with any floor?  ", a: "Most floors, yes. Tile and stone hold heat well, and we can advise on wood and carpet.  " },
  { q: "Is underfloor heating cheap to run? ", a: "Run well, yes. Even heat at a lower temperature can use less gas over time.  " },
  { q: "Can you fit in one room only? ", a: "Yes. Many people start with a kitchen or bathroom. " },
];
      ...
      <section className="relative w-full h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight text-[#027cc1]">
            Underfloor Heating <span className="text-orange-500 whitespace-nowrap"> Installation</span>
          </h1>
          <p className="text-lg text-gray-800 max-w-2xl mx-auto mt-6 font-medium">
Underfloor heating warms the whole room from the ground up. No cold spots, no radiators taking up wall space. 

We fit for new builds, extensions, and rooms you do up, then set the controls for easy use.          </p>
