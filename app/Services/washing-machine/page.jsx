...
const faqs = [
  { q: "Can you take my old machine away? ", a: "Yes. We can remove your old machine and leave the space clear." },
  { q: "Do you check for leaks? ", a: "Yes. We test every joint and run a cycle before we go.  " },
  { q: "How long does the fit take? ", a: "Most fits take well under an hour.  " },
];
...
A new washing machine needs a clean, leak free fit. We plumb yours in and test the job before we go. 

We link the water and waste, check for leaks, and run a cycle to be sure.         </p>
